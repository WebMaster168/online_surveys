...
const OptionRankField = ({optionTitle, handleRemoveOption, optionsLength, handleChangeQuestionOption, questionIndex,optionIndex}) => {
    return (
        
        <div className='question__option'>
            <li className='rank--prototype'><input type="text" disabled /></li>
...
export default OptionRankField;