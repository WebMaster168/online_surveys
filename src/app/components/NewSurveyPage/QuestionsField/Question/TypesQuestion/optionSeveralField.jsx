...
const OptionSeveralField = ({optionTitle, handleRemoveOption, optionsLength, handleChangeQuestionOption, questionIndex,optionIndex}) => {
    return (
        
        <div className='question__option'>
            <li className='several--prototype'></li>
...
export default OptionSeveralField;