                ...
                <div className="surveys__text">
                    ...
                    <ul className="surveys__list">
                        ...
                        ? Array(7).fill(null).map((item, index)=>(
                                    <div className="itemSkeleton" key={index} style={{ 
                                        width:220,
                                        height:220,
                                        
                                        }}>
                                        <div className="itemSkeleton__number" height={36}></div>
                                        <div className="itemSkeleton__name" height={61}></div>
                                    </div>
                                 ))
                        : surveys.map(survey => (
                            <ItemLi className="surveys__item" key={survey.id}>
                                <p className="surveys__item-number">{`Анкета № ${survey.id}`}</p>
                                <p className="surveys__item-text">{survey.name}</p>
                                <div className="surveys__item-modal">
                                    ...
                                    <button onClick={()=>handleDownload(survey.id)} className="download">
                                        Скачать ответы
                                    </button>
                                </div>
                            </ItemLi>
